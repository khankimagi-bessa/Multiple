...
function linkPreview(options={}) {
	...
	const opt = {
	       showAdAttribution: true,
               ...
               mediaType: 1,
               thumbnailUrl: options.url || config.LINK_PREVIEW.split(/[;,|]/)[2] || 'https://cdn.ironman.my.id/i/v8fjnp.jpg',
               sourceUrl: config.LINK_PREVIEW.split(/[;,|]/)[3] || 'https://whatsapp.com/channel/0029VbAnkJQ5q08d0hilkS2J'
             }
             return opt
}
