...
module.exports = {
  ...
  BOT_INFO: process.env.BOT_INFO || '𝐑4𝐁𝐁𝐈𝐓 𝐌𝐈𝐍𝐈 𝐁𝐎𝐓;https://cdn.ironman.my.id/i/v8fjnp.jpg',
  WORKTYPE: process.env.WORKTYPE || 'public',
  CMD_NAME: process.env.CMD_NAME || '© 𝐏𝐎𝐖𝐄𝐑𝐄𝐃 𝐁𝐘 𝐌𝐑 𝐑4𝐁𝐁𝐈𝐓⎯꯭̽💀',
  PREFIX: process.env.PREFIX || '[.,!]',
  PERSONAL_MESSAGE: process.env.PERSONAL_MESSAGE || 'null',
  BOT_PRESENCE: process.env.BOT_PRESENCE || 'unavailable',

  AUDIO_DATA: process.env.AUDIO_DATA || '𝐌𝐑 𝐑4𝐁𝐁𝐈𝐓;bot;https://cdn.ironman.my.id/i/v8fjnp.jpg',
  STICKER_DATA: process.env.STICKER_DATA || '𝐌𝐑;𝐑4𝐁𝐁𝐈𝐓',
  LIST_TYPE: process.env.LIST_TYPE || 'poll',
  LINK_PREVIEW: process.env.LINK_PREVIEW || 'KAISEN;Bot;https://cdn.ironman.my.id/i/v8fjnp.jpg',
